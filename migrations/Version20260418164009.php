 ...
 */
final class Version20260418164009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE oeuvre (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_creation DATE NOT NULL, image VARCHAR(2048) NOT NULL, type VARCHAR(255) NOT NULL, embedding JSON DEFAULT NULL, image_embedding JSON DEFAULT NULL, collection_id INT NOT NULL, classe VARCHAR(255) NOT NULL, INDEX IDX_35FE2EFE514956FD (collection_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, code_qr VARCHAR(2048) NOT NULL, date_achat DATE NOT NULL, evenement_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_97A0ADA3FD02F13 (evenement_id), INDEX IDX_97A0ADA3A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
